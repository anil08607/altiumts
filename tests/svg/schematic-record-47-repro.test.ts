...
test("renders the DSP/FPGA switch owning a typed Record 47 mapping", async () => {
  ...
  const svg = serializeAltiumSheetToSvg(document, {
    height: 624,
    showBorder: false,
    title: "DSP/FPGA S3 switch with Record 47 mapping",
  ...
  const fullSheetSvg = serializeAltiumSheetToSvg(document, {
    title: "DSP/FPGA full schematic with Record 47 mapping",
  })
